...
<div class="wp-block-group is-vertical is-layout-flex wp-container-core-group-is-layout-f58ef9c0 wp-block-group-is-layout-flex" style="margin-top:var(--wp--preset--spacing--10);margin-bottom:var(--wp--preset--spacing--10)"><p style="font-size:clamp(0.875rem, 0.875rem + ((1vw - 0.2rem) * 0.625), 1.25rem);text-transform:uppercase">Donnerstag</p>
<p></p><ul style="list-style-type: none; padding: 0;">
<li><a href="https://www.dongopenair.de/band-details/?band=Vanaheim&amp;doa_year=2025"><div style="display: inline; color: var(--wp--preset--color--base-2)">14:35</div> Vanaheim</a></li>
</ul><p></p>
</div>
...
<div style="position: relative; margin: 0.5em 1.5em;"><a href="https://www.dongopenair.de/band-details/?band={artist_that_has_issue}&amp;doa_year=2025"><img decoding="async" src="/wp-content/plugins/dong_magic/files/doa_2025/bands/kissin_dynamite.jpg" style="z-index: 0; max-width: 25em; min-width: 10em;  aspect-ratio: 2/1; object-fit: cover;"></a><a style="color: #ffffff; text-shadow: 2px 2px black; font-size: 1.5em; z-index: 1; position: absolute; left: 0; top: 40%; width: 100%; text-align: center;" href="https://www.dongopenair.de/band-details/?band={artist_that_has_issue}&amp;doa_year=2025">\n\n</a></div>
</div>
</div></div><p></p></div>
